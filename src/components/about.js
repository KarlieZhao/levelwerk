...
<p>We offer:
    ...
    <li>Social media promotion</li>
        ...
        <li>Tools: a 3D printer, installation/sculpture toolkit, soldering station, projector, drop cloth, etc.</li>
        <li>Studio visits</li>
        <li>A recommendation list of our favorite coffee spots and galleries!</li>
    </ul>
</p><br/>
<p>Past residents info coming soon!</p>
</div>
</main>
</div>)
}